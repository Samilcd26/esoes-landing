...
const calendarEventsToMotionEvents = (events: CalendarEvents[]): MotionCalendarEvent[] => {
...
export default function CalendarPage() {
  ...
  if (calendarLoading) {
    return (
      <LoadingSpinner 
      title="Yükleniyor..."
      subtitle="Etkinlikler getiriliyor"
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-white mb-4">Hata Oluştu</h1>
          <p className="text-red-400">Etkinlikler yüklenirken bir hata oluştu. Lütfen daha sonra tekrar deneyin.</p>
        </div>
      </div>
    );
  }
        ...
        <div className="container mx-auto px-4">
            <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Yaklaşan etkinliklerimizi ve aktivitelerimizi keşfedin
                </p>
            </div>
