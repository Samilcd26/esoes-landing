    ...
    content: () => {
      return (
        <div className="space-y-6">
          ...
          {((department.responsible && department.responsible.length > 0) || (hsdUsers && hsdUsers.length > 0)) && (
            <div>
              ...
              <div className="space-y-3">
                ...
                {department.responsible && department.responsible.map((person, index) => (
                ...
                {/* HSD Category Users */}
                {hsdUsers && hsdUsers.map((user) => (
                  <div key={`hsd-${user._id}`} className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-lg p-4 border-l-4 border-green-500">
                    <div className="flex items-start gap-3">
                      <div className="flex-shrink-0">
                        <div className="w-12 h-12 rounded-full bg-gradient-to-br from-green-400 to-emerald-500 flex items-center justify-center text-white font-semibold text-sm">
                          {user.profileImage ? (
                            <Image 
                              src={urlFor(user.profileImage).width(48).height(48).url()}
